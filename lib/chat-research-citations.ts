...
export function buildEnsureInTextCitationsPrompt(style: CitationStyle): string {
	...
	return [
		...
		"Introduction: 8–12 distinct cites. Literature Review: 10–16. Methodology: 4–8. Results / Analysis: 3–6. Discussion: 8–12. Conclusion: 3–6 (scale down if the retrieval bank is smaller).",
		...
		"Prefer grounded synthesis over padding density with unrelated bank keys.",
		"References: list exactly the bank papers cited in the body; format as Author (Year). Title. [Source](url).",
