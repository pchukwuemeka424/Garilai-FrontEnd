...
function ResearchOutlineContent({ variant = "lecturer" }: Props) {
	...
	const confirmGenerateResearch = useCallback(
		(style: CitationStyle) => {
			...
			router.push(
				researchPaperWorkspacePath(context.idea.title, isStudent ? "student" : "lecturer", nextKey),
			);
		},
			...
			<ResearchCitationStyleModal
				...
				note={
					fromResearchNote
						...
						: "Your outline will guide section structure. Citations and the References list will use your chosen style."
				}
